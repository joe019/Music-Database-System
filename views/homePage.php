...
<div ng-controller="homePageController">
    ...
    <div class=" container-fluid">
        <div class="row">
            <div class="col-md-8">
                <img src="views/images/mdbs.jpg" style="width: 94%; margin-left: -8px; margin-top: 6px;">
            </div>
            <div class="col-md-4" style="left: -36px; top: 85px;">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-offset-3">
                                                <input type="submit" name="register-submit" id="register-submit" tabindex="4" 
                                                       class="form-control btn btn-register" value="Register Now" ng-click="registerUser()">
                                            </div>
                                        </div>
                                    </div>
                                </form>
